...
\redTitle{Communio --- 1\textsuperscript{st} Sunday of Lent}

\greannotation{III}
\gregorioscore[a]{scapulis-suis.gtex}

\newpage

\redTitle{Communio --- 2\textsuperscript{nd} Sunday of Lent}

\greannotation{V}
\gregorioscore[a]{intellige-clamorem.gtex}

\newpage

\redTitle{Communio --- 3\textsuperscript{rd} Sunday of Lent}

\greannotation{I}
\gregorioscore[a]{passer-invenit.gtex}

\newpage

\redTitle{Communio --- 4\textsuperscript{th} Sunday of Lent}

\greannotation{IV}
\gregorioscore[a]{jerusalem-quae-aedificatur.gtex}

\newpage

\redTitle{Communio --- 5\textsuperscript{th} Sunday of Lent}

\greannotation{VIII}
\gregorioscore[a]{hoc-corpus.gtex}

\newpage

\redTitle{Communio --- Palm Sunday}

% \greannotation{VIII}
% \gregorioscore[a]{pater-si-non-potest.gtex}

\newpage

\redTitle{Communio --- 5\textsuperscript{th} Sunday of Lent and Palm Sunday --- from the \emph{Graduale Simplex}}
...
\textit{Quid re}tríbuam \textbf{Dó}mino \GreStar\ pro ómnibus quæ retrí\textit{buit} \textbf{mi}hi?

\textit{Cáli}cem salutáris ac\textbf{cí}piam, \GreStar\ et nomen Dómini \textit{invo}\textbf{cá}bo.

\textit{Vota} mea Dómino \textbf{red}dam \GreStar\ coram omni pó\textit{pulo} \textbf{e}jus.

\textit{Preti}ósa in conspéctu \textbf{Dó}mini \GreStar\ mors sanc\textit{tórum} \textbf{e}jus.

\textit{O Dó}mine quia ego servus \textbf{tu}us ; \GreStar\ ego servus tuus, et filius an\textit{cíllæ} \textbf{tu}æ.

\textit{Diru}písti víncula mea : \GreDagger\ tibi sacrificábo hóstiam \textbf{lau}dis, \GreStar\ et nomen Dómini \textit{invo}\textbf{cá}bo.

\textit{Vota} mea Dómino \textbf{red}dam \GreStar\ in conspéctu omnis pó\textit{puli} \textbf{e}jus.

\textit{In á}triis domus \textbf{Dó}mini, \GreStar\ in médio tu\textit{i, Je}\textbf{rú}salem. 
